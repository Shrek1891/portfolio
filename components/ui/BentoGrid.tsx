    ...
    return (
        ...
        >
            <div className={`${id === 6 && "flex justify-center"} h-full`}>
                ...
                {id === 2 && <GlobeDemo/>}
                {id === 3 && (
                    <div className="flex gap-1 lg:gap-5 w-fit absolute right-10 lg:right-10 top-[20%]">
                        {/* tech stack lists */}
                ...
                {id === 6 && (
                    ...
                    <div className="mt-5 relative">
                        ...
                        <div
                            className={`absolute flex justify-center flex-col right-0 z-50 ${copied ? "block" : "block"
                            }`}
                        >
